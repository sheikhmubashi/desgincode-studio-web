...
export const metadata: Metadata = {
 title: "About Us",
 description:
  "Founded in 2016, we are an architecture and interior-architecture practice based in Karachi.",
};
...
export default async function AboutUs() {
 ...
 return (
  <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10">
   {/* ── ABOUT US ── */}
   <section className="md:mb-10 mb-5">
   ...
   <section className="md:mb-10 mb-5">
    ...
    {data?.approachParagraphs?.map((paragraph, i) => (
     <p
      key={i}
      className="font-body md:text-2xl sm:text-xl text-[#2E2E2E] mb-6 last:mb-0"
     >
      {paragraph}
     </p>
    ))}
