...
export const metadata: Metadata = {
  title: 'Interiors',
  description: 'Explore our interior design projects — corporate, hospitality and residential spaces.',
}
          ...
          <section className="mb-[40px]">
            ...
            {project.description && (
              <div className="max-w-[1164px]">
                <p className="font-body md:text-2xl sm:text-xl text-[#2E2E2E]">{project.description}</p>
              </div>
            )}
          </section>
